...
const mafiaRoles = [
  {
    ...
    icon: Skull,
    tone: 'tone-mafia',
    text: 'Звичайні мафіозі прокидаються разом і мають обрати одну й ту саму ціль. Якщо стріляє тільки одна мафія або цілі різні - це промах.',
  },
  {
    name: 'Коханка',
    icon: Crown,
...
const nightOrder = ['Коханка', 'Лікар', 'Комісар', 'Мафія']
          ...
          <div className="grid gap-4 md:grid-cols-2">
            <article className="surface-card rounded-2xl p-5">
              ...
              <p className="rounded-xl border border-[hsl(var(--secondary)/0.45)] bg-[hsl(var(--secondary)/0.1)] p-3 text-sm text-[hsl(var(--muted-foreground))]">
                Таймери: Коханка, Лікар і Комісар мають по 15 секунд, Мафія має 30 секунд.
              </p>
            </article>
            ...
            <article className="surface-card rounded-2xl p-5">
              ...
              <p className="mb-3 text-[hsl(var(--muted-foreground))]">
                Спочатку кожен живий гравець має 60 секунд на власну промову. Перший спікер зміщується кожного нового дня.
              </p>
              <p className="text-[hsl(var(--muted-foreground))]">
                Після індивідуальних промов іде 90 секунд загального обговорення, потім голосування.
              </p>
            </article>
          </div>
        </section>
